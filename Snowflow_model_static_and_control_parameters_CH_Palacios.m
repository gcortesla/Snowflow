function [control_params,params] = Snowflow_model_static_and_control_parameters_CH_Palacios(basin, run_sce, scenario, years, flag_SWE, flag_Q, precip_scaling)
...
params.DW       = 6;            % Deep water capacity (m), the larger, the more damped are flows throuhgout the year.
...
params.T_snowmelt   = 276.5;  % Snowmelt temp. (K, corresponds to 1.45 C used by Condom et al. 2011)
